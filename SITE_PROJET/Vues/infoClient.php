...
<h1>Les informations sur les clients</h1>

<form method="POST" action="..\Controleur\client_traitement.php">
<SELECT  name="choix">

<OPTION Value="All" SELECTED>TOUS</OPTION>
<OPTION Value="hebdomadaire">Les clients hebdomadaires</OPTION>
</SELECT>
...
<table>
<tr> <th>Nom</th> <th>Prenom</th> <th>Adresse</th> <th>Ville</th> <th>Code postale</th> <th>Numéro de téléphone</th> <th>Adresse e-mail</th>
</tr>
<?php
session_start();

include("..\Modele\connection.php");
$resultat = mysqli_query($co,"SELECT *  FROM individu WHERE nomInd <>'root' AND prenomInd <> 'root'");
while($donnees = mysqli_fetch_assoc($resultat))
{
echo "<tr>";
echo "<td>".$donnees['nomInd']."</td>"."<td>".$donnees['prenomInd']."</td>"."<td>".$donnees['adresse']."</td>"."<td>".$donnees['ville']."</td>"."<td>".$donnees['codePostal']."</td>"."<td>".$donnees['tel']."</td>"."<td>".$donnees['mail']."</td>";
echo "</tr>";
}
