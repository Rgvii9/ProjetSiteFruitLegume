...
<h1>Les informations sur les clients hebdomadaires</h1>

<form method="POST" action="..\Controleur\client_traitement.php">
<SELECT  name="choix">

<OPTION Value="All" >TOUS</OPTION>
<OPTION Value="hebdomadaire" SELECTED>Les clients hebdomadaires</OPTION>
</SELECT>
...
{
echo "<tr>";
echo "<td>".$donnees['nomInd']."</td>"."<td>".$donnees['prenomInd']."</td>"."<td>".$donnees['adresse']."</td>"."<td>".$donnees['ville']."</td>"."<td>".$donnees['codePostal']."</td>"."<td>".$donnees['tel']."</td>"."<td>".$donnees['mail']."</td>"."<td>";
echo "</tr>";
}
