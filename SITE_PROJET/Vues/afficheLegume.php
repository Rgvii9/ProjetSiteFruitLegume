...
<h1>Les l&eacute;gumes disponibles</h1>
<form method="POST" action="..\Controleur\affiche_traitement.php">
<SELECT  name="choix">

<OPTION Value="All" >TOUS</OPTION>
<OPTION Value="fruits">Fruits</OPTION>
<OPTION Value="legumes" SELECTED>l&eacute;gume</OPTION>
</SELECT>
...
$resultat = mysqli_query($co,"SELECT *  FROM aliment WHERE typeAl='legume' AND qteStock <> 0");
